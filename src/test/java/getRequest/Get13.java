...

{
    ...
    public void get13() {
        ...
        GoRestCoApiPojo goRestCoApiPojo = new GoRestCoApiPojo(724776, "Divakar Guha", "guha_divakar@witting.co", "male", "active");
        System.out.println("GoRestCoApi :" + goRestCoApiPojo);
