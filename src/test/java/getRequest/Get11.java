...
public class Get11 extends ApiZippopotamBaseURL {
    ...
    "places": [
        ...
        //içteki yapıyı düzenledikten sonra dışa geldik.
        ...
        assertEquals(zippoPotamPojos.getZippoPotamPlaces().getPlaceName(), (((Map) ((List) actualDataMap.get("places")).get(0))).get("place name"));//cast yaptık
    ...
    /*
    Pojo classları create edebilmek için https://www.jsonschema2pojo.org/ adresine gidip expected
     datayı yapıştırıyoruz.Burada json objesinden pojo class oluşturuyoruz
     */
}